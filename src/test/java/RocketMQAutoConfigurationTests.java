...
import com.cjie.spring.starter.rocketmq.RocketMQAutoConfiguration;
...
import com.cjie.spring.starter.rocketmq.core.RocketMQMessage;
...
public class RocketMQAutoConfigurationTests {
    ...
    public void rocketMQTemplate() {
        ...
        assertThat(this.context.containsBean("rocketMQProducer")).isTrue();
        assertThat(this.context.getBeansOfType(DefaultRocketMQListenerContainer.class)).isEmpty();

        RocketMQProducer rocketMQProducer = this.context.getBean(RocketMQProducer.class);

        DefaultMQProducer defaultMQProducer = rocketMQProducer.getProducer();
        ...
        RocketMQMessage mqMessage = RocketMQMessage.builder().topic("test").body(new TestData()).build();
        rocketMQProducer.syncSend(mqMessage);
    }

    @Data
    private static class TestData implements Serializable {
        private String id ="2313";

        private String name = "adb";
    }
    ...
    public void enableProducer() {
        ...
        assertThat(this.context.containsBean("mqProducer")).isTrue();
        assertThat(this.context.containsBean("rocketMQProducer")).isEqualTo(true);
        assertThat(this.context.getBeansOfType(DefaultRocketMQListenerContainer.class)).isEmpty();
    ...
    public void enableConsumer() {
        ...
        assertThat(this.context.containsBean("mqProducer")).isFalse();
        assertThat(this.context.containsBean("rocketMQProducer")).isFalse();
    ...
    private static class MyListener implements RocketMQListener<TestData> {
